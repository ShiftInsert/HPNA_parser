...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.replace = QPlainTextEdit()                                 # Replace pattern
        ...
        self.replace.setPlainText("\n".join(self.yaml_config['replace_pattern']))
